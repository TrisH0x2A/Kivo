...
import { createCollection, createDefaultStore, createRequest, createWorkspace, REQUEST_MODES } from "../../src/lib/workspace-store.js";
...
window.__TAURI_INTERNALS__ = {
  ...
  async invoke(command, args = {}) {
    switch (command) {
      ...
      case "get_workspace_environments_cmd": return { activeEnvironmentId: "default", environments: [{ id: "default", name: "Default" }] };
