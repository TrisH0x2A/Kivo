...
const IMPORT_EXPORT_FORMATS = [
  ...
  { value: "insomnia", label: "Insomnia v4 (JSON)", extension: "json" },
...
const SUPPORTED_IMPORT_FORMATS_LABEL = "Supported formats: Kivo JSON, Postman, Insomnia v4, OpenAPI 3.0, Swagger 2.0, Bruno (JSON/YAML).";
