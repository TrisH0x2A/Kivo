      ...
      <aside className="kivo-settings-rail kivo-scrollbar-none flex min-h-0 flex-col overflow-y-auto overflow-x-hidden px-3 py-4">
        <div className="mb-4 flex items-center gap-3 px-2">
          ...
          <div className="min-w-0">
            <h2 className="[overflow-wrap:anywhere] text-[15px] font-semibold leading-snug text-foreground">App Settings</h2>
            <p className="mt-0.5 text-[11px] text-muted-foreground/75">Preferences and runtime</p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1 [overflow-wrap:anywhere]">
                  <span className="block text-[12px] font-medium leading-4 text-foreground">{section.label}</span>
                  <span className="mt-1 block text-[10.5px] leading-4 text-muted-foreground">{section.description}</span>
                </span>
              </button>
            );
          })}
